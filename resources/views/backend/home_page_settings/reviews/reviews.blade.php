      ...
      <div class="card">
          <div class="card-header">
              <div class="row">
                  <div class="col-md-6">
                      <h5>
                          <strong class="mr-3">Reviews</strong>
                      </h5>
                  </div>
                  <div class="col-md-6">
                      <button
          ...
          <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content">
                  <div class="modal-header">
                      <h5 class="modal-title" id="exampleModalCenterTitle"><strong>Add New Review</strong></h5>
                  ...
                  <div class="col-md-10">
                      <form action="{{route('theme.reviews.create')}}" method="post" enctype="multipart/form-data">
                          @csrf
                      ...
                      <div class="form-group">
                          ...
                          <input type="Text" class="form-control" name="review_subtitle" placeholder="Sub Title" />
                      </div>
                      <div class="form-group">
                                <label for="inputEmail4"><b>Description</b></label>
                                <small>(In Any Language)</small>
                                    <textarea id="textarea" name="review_description" class="form-control" placeholder="Type Description"></textarea>
                                </div>
                                <br>
                      <div class="form-group">
...
<script>
    function edit_review(review_id) {
        $.ajax({
            type: "GET",
            url: "<?php echo env('APP_URL'); ?>theme/reviews/edit/" + review_id,
            dataType: 'JSON',
