...
@section('content')
    <?php
    $url = env('APP_URL') . 'api/checkout/' . $id;
    $cSession = curl_init();
    curl_setopt($cSession, CURLOPT_URL, $url);
    curl_setopt($cSession, CURLOPT_RETURNTRANSFER, true);
    curl_setopt($cSession, CURLOPT_HEADER, false);
    $result = curl_exec($cSession);
    $chack = json_decode($result);
    curl_close($cSession);
    //dd($chack);
    ?>
                            ...
                            <div class="bg-gray-1 rounded-lg">
                                ...
                                <div class="p-4 mb-4 checkout-table">
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                        <tr class="cart_item">
                                            <td>{{$chack->name}}<strong class="product-quantity">× 1</strong></td>
                                            <td>{{getsettings('Currency')}} {{$chack->selling_price}}</td>
                                        </tr>
{{--                                        <tr class="cart_item">--}}
...
{{--                                        </tr>--}}
                                        ...
                                        <tr>
                                            ...
                                            <td><div class="border-bottom border-color-1 border-dotted-bottom">
                                                    ...
                                                    <div id="basicsCollapseOnee" class="collapse show border-top border-color-1 border-dotted-top bg-dark-lighter"
                                                        ...
                                                        <div class="p-4">
                                                            @foreach($chack->shipping as $Vall)
                                        ...
                                        <tr>
                                            <th>Total</th>
                                            <td><strong>{{getsettings('Currency')}}  {{$chack->selling_price}}</strong></td>
                                        </tr>
                                        </tfoot>
                                    </table>
                                    <!-- End Product Content -->
