...
@section('content')
    ...
    <?php
    $back = $obj->homePageSattings();
    ?>


    @if(getsettings('Slider'))

    @if(isset($slider))
        <!-- Slider Section -->
        <div class="mb-5">
            <div class="bg-img-hero" style="background-image:url({{URL::to($back->background_Image)}}
                                ...
                                <div class="row min-height-420 py-7 py-md-0">
                                    <div class="offset-xl-3 col-xl-4 col-6 mt-md-8">
                                        <h1 class="font-size-64 text-lh-57 font-weight-light"
                                            ...
                                            <span class="d-block font-size-55">{{$v_slider->title}}</span>
                                        </h1>
                                        <h6 class="font-size-15 font-weight-bold mb-3"
                                            data-scs-animation-in="fadeInUp"
                                            data-scs-animation-delay="200">{{$v_slider->sub_title}}
                                        </h6>
                                        <div class="mb-4"
                                             data-scs-animation-in="fadeInUp"
                       ...
                       class="d-black text-gray-90">
                        <div class="min-height-132 py-1 d-flex bg-gray-1 align-items-center">
                            <div class="col-6 col-xl-5 col-wd-6 pr-0">
                                <img class="img-fluid" src="{{asset('frontend/electro/img/190X150/img1.png')}}" alt="Image Description">
                            </div>
                ...
                <div class="col-md-6 mb-4 mb-xl-0 col-xl-3">
                    <a href="https://transvelo.github.io/electro-html/2.0/html/shop/shop.html"
                       class="d-black text-gray-90">
                        <div class="min-height-132 py-1 d-flex bg-gray-1 align-items-center">
                            <div class="col-6 col-xl-5 col-wd-6 pr-0">
                                <img class="img-fluid" src="{{asset('frontend/electro/img/190X150/img2.jpg')}}" alt="Image Description">
                            </div>
                            <div class="col-6 col-xl-7 col-wd-6">
                                <div class="mb-2 pb-1 font-size-18 font-weight-light text-ls-n1 text-lh-23">
                                    CATCH BIG <strong>DEALS</strong> ON THE CAMERAS
                ...
                <div class="col-md-6 mb-4 mb-xl-0 col-xl-3">
                    <a href="https://transvelo.github.io/electro-html/2.0/html/shop/shop.html"
                       class="d-black text-gray-90">
                        <div class="min-height-132 py-1 d-flex bg-gray-1 align-items-center">
                            <div class="col-6 col-xl-5 col-wd-6 pr-0">
                                <img class="img-fluid" src="{{asset('frontend/electro/img/190X150/img3.jpg')}}" alt="Image Description">
                            </div>
                            <div class="col-6 col-xl-7 col-wd-6">
                                <div class="mb-2 pb-1 font-size-18 font-weight-light text-ls-n1 text-lh-23">
                                    CATCH BIG <strong>DEALS</strong> ON THE CAMERAS
                ...
                <div class="col-md-6 mb-4 mb-xl-0 col-xl-3">
                    <a href="https://transvelo.github.io/electro-html/2.0/html/shop/shop.html"
                       class="d-black text-gray-90">
                        <div class="min-height-132 py-1 d-flex bg-gray-1 align-items-center">
                            <div class="col-6 col-xl-5 col-wd-6 pr-0">
                                <img class="img-fluid" src="{{asset('frontend/electro/img/190X150/img4.png')}}" alt="Image Description">
                            </div>
                            <div class="col-6 col-xl-7 col-wd-6">
                                <div class="mb-2 pb-1 font-size-18 font-weight-light text-ls-n1 text-lh-23">
                                    CATCH BIG <strong>DEALS</strong> ON THE CAMERAS
                    ...
                    <div class="p-3 border border-width-2 border-primary borders-radius-20 bg-white min-width-370">
                        ...
                        <div class="mb-4">
                            <a href="#" class="d-block text-center"><img class="img-fluid"
                                                                         src="{{asset('frontend/electro/img/320X300/img1.jpg')}}"
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                <div class="tab-pane fade pt-2 show active" id="pills-one-example1" role="tabpanel"
                                    ...
                                    <ul class="row list-unstyled products-group no-gutters">
                                        ...
                                        @foreach($Prodcut as $v_all)
                                            <li class="col-6 col-wd-3 col-md-4 product-item">

                                                <div class="product-item__outer h-100">
                                                    <div class="product-item__inner px-xl-4 p-3">
                                                        <div class="product-item__body pb-xl-2">
                                                            <div class="mb-2"><a href="{{$v_all->brand.'?=_trkparms='}}"
                                                                                 class="font-size-12 text-gray-5">{{$v_all->brand}}</a>
                                                            </div>

                                                            <h5 class="mb-1 product-item__title"><a
                                                                    href="https://transvelo.github.io/electro-html/2.0/html/shop/single-product-fullwidth.html"
                                                                    class="text-blue font-weight-bold">{{$v_all->name}}</a>
                                                            </h5>
                                                            <div class="mb-2">
                                                                <a href="https://transvelo.github.io/electro-html/2.0/html/shop/single-product-fullwidth.html"
                                                                   class="d-block text-center"><img class="img-fluid"
                                                                                                    style="width: 150px;height: 100px;"
                                                                                                    src="{{URL::to($v_all->image)}}"
                                                                                                    alt="Image Description"></a>
                                                            </div>
                                                            <div class="flex-center-between mb-1">
                                                                <div class="prodcut-price">
                                                                    <div class="text-gray-100">
                                                                        ${{$v_all->selling_price}}</div>
                                                                </div>
                                                ...
                                                <div class="product-item__inner px-xl-4 p-3">
                                                    <div class="product-item__body pb-xl-2">
                                                        ...
                                                        <div class="mb-2">
                                                            <a href="https://transvelo.github.io/electro-html/2.0/html/shop/single-product-fullwidth.html"
                                                               class="d-block text-center"><img class="img-fluid"
                                                                                                src="{{asset('frontend/electro/img/212X200/img2.jpg')}}"
                                                                                                alt="Image Description"></a>
                                                        </div>
                                                        <div class="flex-center-between mb-1">
                                                            <div class="prodcut-price">
                                                ...
                                                <div class="product-item__inner px-xl-4 p-3">
                                                    <div class="product-item__body pb-xl-2">
                                                        ...
                                                        <div class="mb-2">
                                                            <a href="https://transvelo.github.io/electro-html/2.0/html/shop/single-product-fullwidth.html"
                                                               class="d-block text-center"><img class="img-fluid"
                                                                                                src="{{asset('frontend/electro/img/212X200/img3.jpg')}}"
                                                                                                alt="Image Description"></a>
                                                        </div>
                                                        <div class="flex-center-between mb-1">
                                                            <div class="prodcut-price">
                                                ...
                                                <div class="product-item__inner px-xl-4 p-3">
                                                    <div class="product-item__body pb-xl-2">
                                                        ...
                                                        <div class="mb-2">
                                                            <a href="https://transvelo.github.io/electro-html/2.0/html/shop/single-product-fullwidth.html"
                                                               class="d-block text-center"><img class="img-fluid"
                                                                                                src="{{asset('frontend/electro/img/212X200/img4.jpg')}}"
                                                                                                alt="Image Description"></a>
                                                        </div>
                                                        <div class="flex-center-between mb-1">
                                                            <div class="prodcut-price">
                                                ...
                                                <div class="product-item__inner px-xl-4 p-3">
                                                    <div class="product-item__body pb-xl-2">
                                                        ...
                                                        <div class="mb-2">
                                                            <a href="https://transvelo.github.io/electro-html/2.0/html/shop/single-product-fullwidth.html"
                                                               class="d-block text-center"><img class="img-fluid"
                                                                                                src="{{asset('frontend/electro/img/212X200/img5.jpg')}}"
                                                                                                alt="Image Description"></a>
                                                        </div>
                                                        <div class="flex-center-between mb-1">
                                                            <div class="prodcut-price">
                                                ...
                                                <div class="product-item__inner px-xl-4 p-3">
                                                    <div class="product-item__body pb-xl-2">
                                                        ...
                                                        <div class="mb-2">
                                                            <a href="https://transvelo.github.io/electro-html/2.0/html/shop/single-product-fullwidth.html"
                                                               class="d-block text-center"><img class="img-fluid"
                                                                                                src="{{asset('frontend/electro/img/212X200/img1.jpg')}}"
                                                                                                alt="Image Description"></a>
                                                        </div>
                                                        <div class="flex-center-between mb-1">
                                                            <div class="prodcut-price">
                                                ...
                                                <div class="product-item__inner px-xl-4 p-3">
                                                    <div class="product-item__body pb-xl-2">
                                                        ...
                                                        <div class="mb-2">
                                                            <a href="https://transvelo.github.io/electro-html/2.0/html/shop/single-product-fullwidth.html"
                                                               class="d-block text-center"><img class="img-fluid"
                                                                                                src="{{asset('frontend/electro/img/212X200/img7.jpg')}}"
                                                                                                alt="Image Description"></a>
                                                        </div>
                                                        <div class="flex-center-between mb-1">
                                                            <div class="prodcut-price">
                                                ...
                                                <div class="product-item__inner px-xl-4 p-3">
                                                    <div class="product-item__body pb-xl-2">
                                                        ...
                                                        <div class="mb-2">
                                                            <a href="https://transvelo.github.io/electro-html/2.0/html/shop/single-product-fullwidth.html"
                                                               class="d-block text-center"><img class="img-fluid"
                                                                                                src="{{asset('frontend/electro/img/212X200/img8.jpg')}}"
                                                                                                alt="Image Description"></a>
                                                        </div>
                                                        <div class="flex-center-between mb-1">
                                                            <div class="prodcut-price">
                                                ...
                                                <div class="product-item__inner px-xl-4 p-3">
                                                    <div class="product-item__body pb-xl-2">
                                                        ...
                                                        <div class="mb-2">
                                                            <a href="https://transvelo.github.io/electro-html/2.0/html/shop/single-product-fullwidth.html"
                                                               class="d-block text-center"><img class="img-fluid"
                                                                                                src="{{asset('frontend/electro/img/212X200/img6.jpg')}}"
                                                                                                alt="Image Description"></a>
                                                        </div>
                                                        <div class="flex-center-between mb-1">
                                                            <div class="prodcut-price">
        ...
        <div class="container">
            ...
            <div class="position-relative text-center z-index-2 mb-3">
                <ul class="nav nav-classic nav-tab nav-tab-sm px-md-3 justify-content-start justify-content-lg-center flex-nowrap flex-lg-wrap overflow-auto overflow-lg-visble border-md-down-bottom-0 pb-1 pb-lg-0 mb-n1 mb-lg-0"
                    ...
                    <?php $i = 0; ?>
                    @if(isset($menu))
                    @foreach($menu as $v_all)
                        <?php $i++; ?>
                        <li class="nav-item flex-shrink-0 flex-lg-shrink-1">
                            <a class="nav-link <?php if ($i == 1) {
                                echo "active";
                            } ?> " id="{{$v_all->slug}}_tab" data-toggle="pill" href="#{{$v_all->slug}}" role="tab"
                               aria-controls="{{$v_all->slug}}" aria-selected="<?php if ($i == 1) {
                                echo "true";
                            } else {
                                echo "false";
                            } ?> ">
            ...
            <div class="tab-content" id="Tpills-tabContent">
                ...
                @foreach($menu as $all)
                    <?php $i++; ?>
                    <div class="tab-pane fade pt-2 <?php if ($i == 1) {
                        echo "show active";
                    } ?> " id="{{$all->slug}}" role="tabpanel" aria-labelledby="{{$all->slug}}_tab">
                        <div class="row no-gutters">
                            <div class="col-md-3 col-wd-4 d-md-flex d-wd-block">
                                <ul class="row list-unstyled products-group no-gutters mb-0 flex-xl-column flex-wd-row">
                                    @foreach($all->product as $all_pro)
                                        <li class="col-xl-6 product-item max-width-xl-100 remove-divider">
                                            <div class="product-item__outer h-100 w-100 prodcut-box-shadow">
                                                <div class="product-item__inner bg-white p-3">
                                                    <div class="product-item__body pb-xl-2">
                                                        <div class="mb-2"><a
                                                                href="{{URL::to('single/'.$all_pro->id."/".$all_pro->slug)}}"
                                                                class="font-size-12 text-gray-5">Speakers</a>
                                                        </div>
                                                        <h5 class="mb-1 product-item__title"><a
                                                                href="{{URL::to('single/'.$all_pro->id."/".$all_pro->slug)}}"
                                                                class="text-blue font-weight-bold">{{$all_pro->name}}</a>
                                                        </h5>
                                                        <div class="mb-2">
                                                            <a href="https://transvelo.github.io/electro-html/2.0/html/shop/single-product-fullwidth.html"
                                                               class="d-block text-center"><img class="img-fluid"
                                                                                                src="{{URL::to($all_pro->image)}}"
                                                                                                alt="Image Description"></a>
                                                        </div>
                                                        <div class="flex-center-between mb-1">
                                                            <div class="prodcut-price">
                                                                <div class="text-gray-100">
                                                                    ${{$all_pro->selling_price}}</div>
                                                            </div>
                                                            <div class="d-none d-xl-block prodcut-add-cart">
                                                                <a href="{{URL::to('single/'.$all_pro->id."/".$all_pro->slug)}}"
                                                                   class="btn-add-cart btn-primary transition-3d-hover"><i
                                                                        class="ec ec-add-to-cart"></i></a>
                                                            </div>
                                                        </div>
                            ...
                            {{--                                                                class="img-fluid"--}}
                            {{--                                                                src="{{asset('frontend/electro/img/564X520/img2.jpg')}}"--}}
                            {{--                                                                alt="Image Description"></a>--}}
                            {{--                                                        <!-- Gallery -->--}}
                            ...
                            {{--                                                                   href="javascript:;"--}}
                            {{--                                                                   data-src="{{asset('frontend/electro/img/1920X1080/img1.jpg')}}"--}}
                            {{--                                                                   data-fancybox="fancyboxGallery6"--}}
                            {{--                                                                   data-caption="Electro in frames - image #01"--}}
                            {{--                                                                   data-speed="700"--}}
                            {{--                                                                   data-is-infinite="true">--}}
                            {{--                                                                    <img class="img-fluid border"--}}
                            {{--                                                                         src="{{asset('frontend/electro/img/100X100/img1.jpg')}}"--}}
                            {{--                                                                         alt="Image Description">--}}
                            ...
                            {{--                                                                <a class="js-fancybox max-width-60 u-media-viewer"--}}
                            {{--                                                                   href="javascript:;"--}}
                            {{--                                                                   data-src="{{asset('frontend/electro/img/1920X1080/img2.jpg')}}"--}}
                            {{--                                                                   data-fancybox="fancyboxGallery6"--}}
                            {{--                                                                   data-caption="Electro in frames - image #02"--}}
                            {{--                                                                   data-speed="700"--}}
                            {{--                                                                   data-is-infinite="true">--}}
                            {{--                                                                    <img class="img-fluid border"--}}
                            {{--                                                                         src="{{asset('frontend/electro/img/100X100/img2.jpg')}}"--}}
                            {{--                                                                         alt="Image Description">--}}
                            ...
                            {{--                                                                <a class="js-fancybox max-width-60 u-media-viewer"--}}
                            {{--                                                                   href="javascript:;"--}}
                            {{--                                                                   data-src="{{asset('frontend/electro/img/1920X1080/img3.jpg')}}"--}}
                            {{--                                                                   data-fancybox="fancyboxGallery6"--}}
                            {{--                                                                   data-caption="Electro in frames - image #03"--}}
                            {{--                                                                   data-speed="700"--}}
                            {{--                                                                   data-is-infinite="true">--}}
                            {{--                                                                    <img class="img-fluid border"--}}
                            {{--                                                                         src="{{asset('frontend/electro/img/100X100/img3.jpg')}}"--}}
                            {{--                                                                         alt="Image Description">--}}
                                    ...
                                    <div class="col col-lg-auto product-media-left">
                                        <a href="https://transvelo.github.io/electro-html/2.0/html/shop/single-product-fullwidth.html"
                                           class="max-width-150 d-block"><img class="img-fluid"
                                                                              src="{{asset('frontend/electro/img/150X140/img1.jpg')}}"
                                                                              alt="Image Description"></a>
                                    </div>
                            ...
                            <div class="product-item__outer h-100">
                                <div class="product-item__inner p-md-3 row no-gutters">
                                    <div class="col col-lg-auto product-media-left">
                                        <a href="https://transvelo.github.io/electro-html/2.0/html/shop/single-product-fullwidth.html"
                                           class="max-width-150 d-block"><img class="img-fluid"
                                                                              src="{{asset('frontend/electro/img/150X140/img2.jpg')}}"
                                                                              alt="Image Description"></a>
                                    </div>
                                    <div class="col product-item__body pl-2 pl-lg-3 mr-xl-2 mr-wd-1">
                                        <div class="mb-4">
                            ...
                            <div class="product-item__outer h-100">
                                <div class="product-item__inner p-md-3 row no-gutters">
                                    <div class="col col-lg-auto product-media-left">
                                        <a href="https://transvelo.github.io/electro-html/2.0/html/shop/single-product-fullwidth.html"
                                           class="max-width-150 d-block"><img class="img-fluid"
                                                                              src="{{asset('frontend/electro/img/150X140/img3.jpg')}}"
                                                                              alt="Image Description"></a>
                                    </div>
                                    <div class="col product-item__body pl-2 pl-lg-3 mr-xl-2 mr-wd-1">
                                        <div class="mb-4">
                            ...
                            <div class="product-item__outer h-100">
                                <div class="product-item__inner p-md-3 row no-gutters">
                                    <div class="col col-lg-auto product-media-left">
                                        <a href="https://transvelo.github.io/electro-html/2.0/html/shop/single-product-fullwidth.html"
                                           class="max-width-150 d-block"><img class="img-fluid"
                                                                              src="{{asset('frontend/electro/img/150X140/img7.jpg')}}"
                                                                              alt="Image Description"></a>
                                    </div>
                                    <div class="col product-item__body pl-2 pl-lg-3 mr-xl-2 mr-wd-1">
                                        <div class="mb-4">
                            ...
                            <div class="product-item__outer h-100">
                                <div class="product-item__inner p-md-3 row no-gutters">
                                    <div class="col col-lg-auto product-media-left">
                                        <a href="https://transvelo.github.io/electro-html/2.0/html/shop/single-product-fullwidth.html"
                                           class="max-width-150 d-block"><img class="img-fluid"
                                                                              src="{{asset('frontend/electro/img/150X140/img4.jpg')}}"
                                                                              alt="Image Description"></a>
                                    </div>
                                    <div class="col product-item__body pl-2 pl-lg-3 mr-xl-2 mr-wd-1">
                                        <div class="mb-4">
                            ...
                            <div class="product-item__outer h-100">
                                <div class="product-item__inner p-md-3 row no-gutters">
                                    <div class="col col-lg-auto product-media-left">
                                        <a href="https://transvelo.github.io/electro-html/2.0/html/shop/single-product-fullwidth.html"
                                           class="max-width-150 d-block"><img class="img-fluid"
                                                                              src="{{asset('frontend/electro/img/150X140/img5.jpg')}}"
                                                                              alt="Image Description"></a>
                                    </div>
                                    <div class="col product-item__body pl-2 pl-lg-3 mr-xl-2 mr-wd-1">
                                        <div class="mb-4">
                            ...
                            <div class="product-item__outer h-100">
                                <div class="product-item__inner p-md-3 row no-gutters">
                                    <div class="col col-lg-auto product-media-left">
                                        <a href="https://transvelo.github.io/electro-html/2.0/html/shop/single-product-fullwidth.html"
                                           class="max-width-150 d-block"><img class="img-fluid"
                                                                              src="{{asset('frontend/electro/img/150X140/img6.jpg')}}"
                                                                              alt="Image Description"></a>
                                    </div>
                                    <div class="col product-item__body pl-2 pl-lg-3 mr-xl-2 mr-wd-1">
                                        <div class="mb-4">
                            ...
                            <div class="product-item__outer h-100">
                                <div class="product-item__inner p-md-3 row no-gutters">
                                    <div class="col col-lg-auto product-media-left">
                                        <a href="https://transvelo.github.io/electro-html/2.0/html/shop/single-product-fullwidth.html"
                                           class="max-width-150 d-block"><img class="img-fluid"
                                                                              src="{{asset('frontend/electro/img/150X140/img8.jpg')}}"
                                                                              alt="Image Description"></a>
                                    </div>
                                    <div class="col product-item__body pl-2 pl-lg-3 mr-xl-2 mr-wd-1">
                                        <div class="mb-4">
...
{{--                <div class="" style="background-image: url({{asset('frontend/electro/img/1400X206/img1.jpg')}};">--}}
...
{{--        </div>--}}
        <!-- End Full banner -->
        <!-- Recently viewed -->
        @if(getsettings('Recently_Viewed'))
        <div class="mb-6">
