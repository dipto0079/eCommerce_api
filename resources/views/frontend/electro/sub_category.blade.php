            ...
            <div class="my-md-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-3 flex-nowrap flex-xl-wrap overflow-auto overflow-xl-visble">
                        ...
                        <li class="breadcrumb-item flex-shrink-0 flex-xl-shrink-1 active" aria-current="page">{{$data->sub->subcategory_name}}
                        </li>
                    </ol>
                </nav>
            </div>
                    ...
                    <li>
                        ...
                        <div id="sidebarNav1Collapse" class="collapse" data-parent="#sidebarNav">
                            <ul id="sidebarNav1" class="list-unstyled dropdown-list">
                                ...
                                <li><a class="dropdown-item" href="{{URL::to('cat/'.$item->id."/".$item->slug)}}">{{ $item->name }}
     ...
     $_child_show =2;
        $i=0;
                        foreach ($categoriesFilters->child as $item) {
                            $i++;
                                if(($_child_show+1)==$i){ break; }
                           ?>

                        <div class="form-group d-flex align-items-center justify-content-between mb-2 pb-1">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" onchange="getProducts(this.value,'sub');" value="<?= $item->name ?>"  id="<?= $item->slug ?>">
                                <label class="custom-control-label" for="<?= $item->slug ?>"><?php echo $item->name; ?> <span
...
foreach ($categoriesFilters->child as $item) {
    ...
    ?>
                       <div class="form-group d-flex align-items-center justify-content-between mb-2 pb-1">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" onchange="getProducts(this.value,'child');" value="<?= $item->name ?>" id="<?= $item->slug ?>">
                            <label class="custom-control-label" for="<?= $item->slug ?>"><?php echo $item->name; ?> <span
                                    class="text-gray-25 font-size-12 font-weight-normal"> (<?php echo $item->count; ?>)</span></label>
                        </div>
                    </div>
                    ...
                    <div class="border-bottom pb-4 mb-4">
                        ...
                        foreach ($categoriesFilters->brand as $item) {
                            $i++;
                            if(($_brand_show+1)==$i){ break; }
                           ?>

                        <div class="form-group d-flex align-items-center justify-content-between mb-2 pb-1">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" onchange="getProducts(this.value,'brand');" value="<?= $item->name ?>"  id="<?= $item->slug ?>">
                                <label class="custom-control-label" for="<?= $item->slug ?>"><?php echo $item->name; ?> <span
                                        class="text-gray-25 font-size-12 font-weight-normal"> (<?php echo $item->count; ?>)</span></label>
                            </div>
                        </div>
                    ...
                    <div class="range-slider">
                        ...
                        <span class="irs js-irs-0 u-range-slider u-range-slider-indicator u-range-slider-grid"><span
                                class="irs"><span class="irs-line" tabindex="0"><span class="irs-line-left"></span><span
                                    ...
                                    class="irs-single" style="display: none; left: 0%;">0</span></span><span
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <h3 class="text-lh-1dot2 font-size-14 mb-0"><a
                                                href="../shop/single-product-fullwidth.html">{{$v_all->name}}</a></h3>
            ...
            <div class="col-xl-9 col-wd-9gdot5">
                ...
                <div class="d-block d-md-flex flex-center-between mb-3">
                    <h3 class="font-size-25 mb-2 mb-md-0">{{$data->sub->subcategory_name}}</h3>
